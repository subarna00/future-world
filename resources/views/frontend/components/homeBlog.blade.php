<?php
$blogs = App\Models\Blog::where("status","active")->latest()->take(3)->get();
?>
            ...
            <div class="col-lg-4 col-md-6 wow move-up">
                ...
                <div class="single-blog-item blog-grid">
                    ...
                    <div class="post-info lg-blog-post-info">
                        ...
                        <div class="btn-text">
                            <a href="{{route("blogDetailPAge",$blog->slug)}}">Read more <i class="ml-1 button-icon far fa-long-arrow-right"></i></a>
                        </div>
                    </div>
                    <!-- Post info End -->
                </div>
