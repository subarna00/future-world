                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            ...
                            <a href="{{ route('courses.create') }}" class="btn btn-sm btn-dark">Create course</a>
                        </div>
                    </div>
                    <!-- /.card-header -->
                            ...
                            <tbody>
                                @foreach ($courses as $course)
                                    <tr>
                                        <td>{{ $course->id }}</td>
                                        <td>{{ $course->title }}</td>
                                        <td><img src="{{ asset('images/' . $course->image) }}" width="90"></td>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" data-toggle="modal" data-target="#exampleModal{{ $course->id }}">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            Are you sure to delete <span
                                                                class="text-red">{{ $course->title }}</span>
                                                            course?
                                                        </div>
