            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Service Sub Type Table</h3>
                        ...
                        <div class="card-tools">
                            ...
                            <a href="{{ route('service-sub-type.create') }}" class="btn btn-sm btn-dark">Create Service Sub Type
                                Type</a>
                        </div>
                    </div>
                    <!-- /.card-header -->
                            ...
                            <tbody>
                                @foreach ($subType as $type)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('service-sub-type.edit', $type->id) }}">
                                                <i class="ri-edit-box-line text-primary mx-1"></i>
                                            </a>
                                            <a href="#" data-toggle="modal" data-target="#exampleModal{{ $type->id }}">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            Are you sure to delete <span
                                                                class="text-red">{{ $type->title }}</span>
                                                            service-types?
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary"
                                                                data-dismiss="modal">Close</button>
                                                            <form action="{{ route('service-sub-type.destroy', $type->id) }}"
                                                                method="POST">
                                                                @csrf
                                                                {{ method_field('DELETE') }}
                                                                <button type="submit"
